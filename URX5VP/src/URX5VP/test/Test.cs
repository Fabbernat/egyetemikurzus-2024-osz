...
namespace URX5VP.test
{
    public class Test
    {
        ...
        {
            string dateStr = DataGenerator.GenerateRandomDate();
            DateTime dateObj;
        ...
        {
            string amountStr = DataGenerator.GenerateRandomAmount();
        ...
        {
            string referenceStr = DataGenerator.GenerateRandomReference();
